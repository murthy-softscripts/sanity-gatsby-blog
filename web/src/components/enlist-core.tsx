...
export default ({ onClose, onSubmit, classExtra, minimal }: IProps) => {
  ...
  return (
    <>
      ...
      <div
        className={`enlist-popup--main ${classExtra ? classExtra : ''} ${
          isSubmitting ? 'enlist-popup--main--bounce-outs' : ''
        } ${minimal ? ' enlist-popup--minimal' : ''}`}
      ...
      >
        <div className="enlist-popup--inner">
          ...
          {minimal && <div className="enlist-popup--title">Join Us!</div>}
           <div class="ngp-form"
